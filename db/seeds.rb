...
# Cohort.create(name: 'Summer', start_date: 20180618, end_date: 20180926, instructor_id: 1, class_id: 1)
# Instructor.create(name: 'David', last_name: 'Patlut', age: 100, salary: 1, education: "Bachelor Degree")
