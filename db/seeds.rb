...
# Instructor.create(name: 'David', last_name: 'Patlut', age: 100, salary: 1, education: "Bachelor Degree", email: "db@email.com", password: "123")
...
# Student.create(name: 'Lily', last_name: 'Ngo', age: 20, email: 'lily@gmail.com', password: '321', cohort_id: 1)
   ...
   User.create(email: "test@gmail.com", encrypted_password:"123456" )